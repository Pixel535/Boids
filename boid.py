...
class Boid(pygame.sprite.Sprite):
    ...
    def cohesion(self):
        ...
        for other_boid in self.flock:##
            ...
            if other_boid is not self and distance_between_boids < BOID_PERCEPTION_DISTANCE and \
                    self.get_angle(self.velocity, np.subtract(self.position, other_boid.position)) < BOID_MAX_ANGLE:
